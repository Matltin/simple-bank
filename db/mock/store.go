...
// Source: github.com/Matltin/simple-bank/db/sqlc (interfaces: Store)
...
func (mr *MockStoreMockRecorder) CreatUser(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ListEnteris mocks base method.
func (m *MockStore) ListEnteris(arg0 context.Context, arg1 db.ListEnterisParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEnteris", arg0, arg1)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEnteris indicates an expected call of ListEnteris.
func (mr *MockStoreMockRecorder) ListEnteris(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEnteris", reflect.TypeOf((*MockStore)(nil).ListEnteris), arg0, arg1)
}
